 ...
 *   {{discussion_topics}}  injected block of topics drained from the person's
 *                          running topics list ("### Discussion topics" +
 *                          unchecked checkboxes), or "" when none are queued
...
{{discussion_topics}}{{carried_forward}}
## Notes
