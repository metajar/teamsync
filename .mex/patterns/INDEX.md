...
| Pattern | Use when |
|---------|----------|
| [add-command-or-view.md](add-command-or-view.md) | Wiring a new Obsidian command, modal, settings tab, or dashboard view to service-layer logic |
| [add-note-type.md](add-note-type.md) | Adding or extending a note type (person, 1:1, goal, dev-plan): template, frontmatter schema, service, command wiring |
| [ollama-feature.md](ollama-feature.md) | Adding any AI-assisted feature that calls the local Ollama server (prep briefs, pattern summaries, draft assist) |
